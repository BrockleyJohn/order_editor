...
define('ENTRY_UPDATE_TO_CC', '(Update to ' . (defined('ORDER_EDITOR_CREDIT_CARD') ? ORDER_EDITOR_CREDIT_CARD : 'payment by credit card') . ' to view CC fields.)');
...
define('SUCCESS_CONFIGS_INSTALLED', 'New configuration settings installed. Please check if the defaults are suitable.');

//the hints
define('HINT_UPDATE_TO_CC', 'Set payment method to ' . (defined('ORDER_EDITOR_CREDIT_CARD') ? ORDER_EDITOR_CREDIT_CARD : 'payment by credit card') . ' and the other fields will be displayed automatically.  CC fields are hidden if any other payment method is selected.  The name of the payment method that, when selected, will display the CC fields is configurable in the Order Editor area of the Configuration section of the Administration panel.');
